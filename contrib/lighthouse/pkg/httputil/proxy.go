...
// ServeHTTP http request handle function
func (p *ReverseProxy) ServeHTTP(rw http.ResponseWriter, req *http.Request) {
	...
	outreq := p.generateOutRequest(ctx, rw, req)
...
func (p *ReverseProxy) generateOutRequest(ctx context.Context, rw http.ResponseWriter, req *http.Request) *http.Request {
...
func (p *ReverseProxy) handleUpgradeResponse(rw http.ResponseWriter, req *http.Request, res *http.Response) {
	...
	// For docker hijack, we shouldn't close socket if one-side is closed
	spc := switchProtocolCopier{user: conn, backend: backConn}
	receiveStdout := make(chan error)

	go func() {
		receiveStdout <- spc.copyFromBackend()
	}()
...
// CloseWriter groups basic write and close methods
